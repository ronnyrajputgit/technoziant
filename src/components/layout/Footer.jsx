            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '24px' }}>
              ...
              <div>
                ...
                <p style={{ fontSize: '11px', color: 'var(--text-muted)', lineHeight: 1.6, marginBottom: '12px' }}>
                  We craft digital products. Creative studio blending storytelling, art, and technology.
                </p>
              ...
              <div>
                ...
                {['Web Development', 'Mobile Apps', 'UI/UX Design', 'Cloud & DevOps', 'AI & ML'].map(s => (
                  <a key={s} href="/services" style={{ display: 'block', fontSize: '11px', color: 'var(--text-muted)', marginBottom: '6px', textDecoration: 'none', transition: 'color 0.2s' }}
                    onMouseEnter={e => e.target.style.color = '#22c55e'} onMouseLeave={e => e.target.style.color = 'var(--text-muted)'}>{s}</a>
                ))}
              </div>
              ...
              <div>
                ...
                {[{ label: 'About', href: '/about' }, { label: 'Work', href: '/work' }, { label: 'Careers', href: '/careers' }, { label: 'Contact', href: '/contact' }, { label: 'FAQ', href: '/faq' }].map(link => (
                  <a key={link.label} href={link.href} style={{ display: 'block', fontSize: '11px', color: 'var(--text-muted)', marginBottom: '6px', textDecoration: 'none', transition: 'color 0.2s' }}
